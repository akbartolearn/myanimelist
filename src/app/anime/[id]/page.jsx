  ...
  return (
    <>
      ...
      <div className="pt-4 px-4 flex gap-2 text-color-primary overflow-x-auto">
        <div className="w-36 flex flex-col justify-center items-center border border-color-primary rounded p-2">
          <h3>Peringkat: </h3>
          <p>{anime.data.rank}</p>
        </div>
        <div className="w-36 flex flex-col justify-center items-center border border-color-primary rounded p-2">
      ...
      <div className="p-4">
        <h3 className="text-2xl text-color-primary mb-2">Komentar Penonton</h3>
